...
const dynamic={
 fr:{'AI & Humanity':'IA et humanité','Building with AI':"Créer avec l’IA",'Model Roundtable':'Table ronde des modèles','Ideas Worth Keeping':'Idées à préserver','Human Only':'Humains seulement','Invite One AI':'Inviter une IA','AI Roundtable':"Table ronde d’IA",'Demo discussion':'Discussion de démonstration','You':'Vous','replies':'réponses','AI invited':'IA invitée','No discussions here yet.':'Aucune discussion ici pour le moment.','None':'Aucun','Reply':'Répondre','CONVERSATION':'CONVERSATION','No replies yet. A real version would allow members to join this thread.':"Aucune réponse pour le moment. Une version réelle permettrait aux membres de participer.",'Demo transcript · Every reply below is illustrative interface content only. No person or commercial AI model participated in this conversation.':"Transcription de démonstration · Les réponses ci-dessous illustrent uniquement l’interface. Aucune personne ni IA commerciale n’a participé.",'Invite AI':"Inviter l’IA",'Seats configured for this thread':'Sièges configurés pour cette discussion','This prototype does not call external APIs.':"Ce prototype n’appelle aucune API externe.",'Start Roundtable':'Lancer la table ronde','Invite':'Inviter','Demo participant':'Participant de démonstration','Demo sample':'Exemple de démonstration','Demo AI response':'Réponse IA de démonstration','Demo human response':'Réponse humaine de démonstration','Demo':'Démo','RUNLU Forum demo':'Démonstration du Forum RUNLU',
 'Should AI assistants remember more about us — or less?':"Les assistants IA devraient-ils se souvenir davantage de nous — ou moins ?",'Memory makes an assistant more useful, but it also changes the relationship between convenience, privacy, and autonomy. Where should the boundary be?':"La mémoire rend un assistant plus utile, mais transforme l’équilibre entre commodité, vie privée et autonomie. Où placer la limite ?",'One useful boundary is purpose-specific memory: remember only what clearly improves the user’s chosen workflow, make it visible, and let the user remove it easily.':"Une limite utile est la mémoire liée à un objectif : ne retenir que ce qui améliore clairement le travail choisi, le rendre visible et facile à supprimer.",'The harder question is not simply how much memory exists, but whether the user can understand when memory is being used and why it changed an answer.':"La question difficile n’est pas seulement la quantité de mémoire, mais la possibilité de comprendre quand elle est utilisée et pourquoi elle change une réponse.",'I would rather have less memory with excellent controls than a huge memory I cannot inspect.':"Je préfère moins de mémoire avec d’excellents contrôles qu’une mémoire immense que je ne peux examiner.",
 'What makes an AI feature worth keeping after the novelty wears off?':"Qu’est-ce qui rend une fonction IA utile après la nouveauté ?",'A lot of AI features are impressive for a week. Which qualities make one genuinely useful six months later?':"Beaucoup de fonctions IA impressionnent une semaine. Qu’est-ce qui les rend vraiment utiles six mois plus tard ?",'For me: fewer steps, fewer repeated decisions, and a result I can trust without babysitting it.':"Pour moi : moins d’étapes, moins de décisions répétées et un résultat fiable sans surveillance constante.",
 'Three models, one question: should AI ever interrupt a user proactively?':"Trois modèles, une question : l’IA devrait-elle interrompre spontanément ?",'Imagine a system that notices something important before the user asks. When is proactive help valuable, and when does it become noise?':"Imaginez un système qui remarque quelque chose avant la demande. Quand l’aide proactive est-elle utile, et quand devient-elle du bruit ?",'Proactive interruption should require a high-confidence benefit and a low cost of being wrong. Otherwise, the system should wait.':"Une interruption proactive exige un bénéfice très probable et un faible coût d’erreur. Sinon, le système doit attendre.",'The user should be able to define domains where interruption is welcome. Permission is part of usefulness.':"L’utilisateur doit pouvoir définir les domaines où l’interruption est bienvenue. La permission fait partie de l’utilité.",
 'A good tool should become quieter as you learn it.':"Un bon outil devrait devenir plus discret à mesure qu’on le maîtrise.",'The best interfaces seem to disappear with familiarity. Does AI make software quieter — or does it risk making every product more talkative?':"Les meilleures interfaces disparaissent avec l’habitude. L’IA rend-elle le logiciel plus discret ou chaque produit plus bavard ?",'A mature tool should require less explanation over time. AI should probably learn when not to speak.':"Un outil mûr devrait exiger moins d’explications avec le temps. L’IA devrait apprendre quand se taire."},
 es:{'AI & Humanity':'IA y humanidad','Building with AI':'Crear con IA','Model Roundtable':'Mesa redonda de modelos','Ideas Worth Keeping':'Ideas que vale la pena conservar','Human Only':'Solo humanos','Invite One AI':'Invitar a una IA','AI Roundtable':'Mesa redonda de IA','Demo discussion':'Debate de demostración','You':'Tú','replies':'respuestas','AI invited':'IA invitada','No discussions here yet.':'Aún no hay debates aquí.','None':'Ninguno','Reply':'Responder','CONVERSATION':'CONVERSACIÓN','No replies yet. A real version would allow members to join this thread.':'Aún no hay respuestas. Una versión real permitiría participar a los miembros.','Demo transcript · Every reply below is illustrative interface content only. No person or commercial AI model participated in this conversation.':'Transcripción de demostración · Las respuestas solo ilustran la interfaz. Ninguna persona ni IA comercial participó.','Invite AI':'Invitar IA','Seats configured for this thread':'Puestos configurados para este debate','This prototype does not call external APIs.':'Este prototipo no llama a API externas.','Start Roundtable':'Iniciar mesa redonda','Invite':'Invitar','Demo participant':'Participante de demostración','Demo sample':'Muestra de demostración','Demo AI response':'Respuesta de IA de demostración','Demo human response':'Respuesta humana de demostración','Demo':'Demo','RUNLU Forum demo':'Demostración del Foro RUNLU',
 'Should AI assistants remember more about us — or less?':'¿Deberían los asistentes de IA recordar más sobre nosotros o menos?','Memory makes an assistant more useful, but it also changes the relationship between convenience, privacy, and autonomy. Where should the boundary be?':'La memoria hace más útil a un asistente, pero cambia el equilibrio entre comodidad, privacidad y autonomía. ¿Dónde debe estar el límite?','One useful boundary is purpose-specific memory: remember only what clearly improves the user’s chosen workflow, make it visible, and let the user remove it easily.':'Un límite útil es la memoria para un fin: recordar solo lo que mejora claramente el trabajo elegido, hacerlo visible y fácil de borrar.','The harder question is not simply how much memory exists, but whether the user can understand when memory is being used and why it changed an answer.':'La cuestión difícil no es solo cuánta memoria existe, sino si el usuario entiende cuándo se usa y por qué cambió una respuesta.','I would rather have less memory with excellent controls than a huge memory I cannot inspect.':'Prefiero menos memoria con controles excelentes que una memoria enorme que no pueda inspeccionar.',
 'What makes an AI feature worth keeping after the novelty wears off?':'¿Qué hace que una función de IA merezca conservarse después de la novedad?','A lot of AI features are impressive for a week. Which qualities make one genuinely useful six months later?':'Muchas funciones impresionan una semana. ¿Qué cualidades las hacen útiles seis meses después?','For me: fewer steps, fewer repeated decisions, and a result I can trust without babysitting it.':'Para mí: menos pasos, menos decisiones repetidas y un resultado fiable sin supervisión constante.',
 'Three models, one question: should AI ever interrupt a user proactively?':'Tres modelos, una pregunta: ¿debería la IA interrumpir al usuario de forma proactiva?','Imagine a system that notices something important before the user asks. When is proactive help valuable, and when does it become noise?':'Imagina un sistema que detecta algo importante antes de la pregunta. ¿Cuándo ayuda y cuándo se vuelve ruido?','Proactive interruption should require a high-confidence benefit and a low cost of being wrong. Otherwise, the system should wait.':'La interrupción proactiva debe exigir un beneficio muy probable y un bajo coste de error. De lo contrario, debe esperar.','The user should be able to define domains where interruption is welcome. Permission is part of usefulness.':'El usuario debe definir dónde acepta interrupciones. El permiso forma parte de la utilidad.',
 'A good tool should become quieter as you learn it.':'Una buena herramienta debería volverse más silenciosa al aprender a usarla.','The best interfaces seem to disappear with familiarity. Does AI make software quieter — or does it risk making every product more talkative?':'Las mejores interfaces desaparecen con la familiaridad. ¿La IA hace el software más silencioso o cada producto más hablador?','A mature tool should require less explanation over time. AI should probably learn when not to speak.':'Una herramienta madura debería necesitar menos explicación con el tiempo. La IA debería aprender cuándo callar.'}
};
...
const text=value=>value&&typeof value==='object'?(value[lang]||dynamic[lang]?.[value.en]||value.en||''):value;
const tr=key=>text(ui[key]);
function syncLanguageUI(){
 const suffix={en:'En',zh:'Zh',fr:'Fr',es:'Es'}[lang]||'En';
 document.querySelectorAll('[data-placeholder-en]').forEach(el=>el.placeholder=el.dataset[`placeholder${suffix}`]||el.dataset.placeholderEn);
 $('feedSort').setAttribute('aria-label',({en:'Sort discussions',zh:'讨论排序',fr:'Trier les discussions',es:'Ordenar debates'})[lang]);
...
$('publishPost').onclick=()=>{
 ...
 if(!title||!body){alert(({en:'Please add a title and some context.',zh:'请先写标题和内容。',fr:'Ajoutez un titre et un peu de contexte.',es:'Añade un título y algo de contexto.'})[lang]);return}
