...
async function inspect(prior){
 ...
 return {hasWorkspace,priorUnclean:!!prior?.sessionOpen,health,schema,durable,comparison,issues,critical,blocked:critical.length>0,checkedAt:new Date().toISOString()};
}
async function boot(){
