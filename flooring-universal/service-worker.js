...
const CACHE='runlu-flooring-universal-shell-v1';
const SHELL=[
 ...
 './universal-data-exchange.css','./universal-local-health.css','./universal-data-version.css','./universal-indexeddb.css','./manifest.webmanifest'
];
