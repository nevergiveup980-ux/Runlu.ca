...
(function(){
'use strict';
const PREFIX='runlu_flooring_universal_',FORMAT='runlu-flooring-universal-backup',VERSION=1;
...
function collect(){
 ...
 keys.filter(k=>k.startsWith(PREFIX)&&k!=='runlu_flooring_universal_data_backend').forEach(k=>{data[k]=adapter.read(k,null)});
