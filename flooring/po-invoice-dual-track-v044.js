...
function openEditable(){preparePreview();const w=window.open('deerfoot-po-invoice-paper-edit-v044.html?t='+Date.now(),'_blank');if(!w)alert('Allow pop-ups to open the editable PO Deerfoot Invoice.')}
