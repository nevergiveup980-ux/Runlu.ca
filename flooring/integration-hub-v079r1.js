/* RUNLU Deerfoot Flooring OS · V0.3.79 Integration Hub Foundation
   Cache-busted R1 copy for production delivery.
...
function install(){
  document.documentElement.setAttribute('data-runlu-integration-hub','v079r1');
  window.dispatchEvent(new CustomEvent('runlu:integration-ready',{detail:{version:'0.3.79-r1',provider:config().provider,enabled:config().enabled}}));
  return true;
}

window.RUNLUIntegrationHubV079={
  version:'0.3.79-r1',capabilities:CAPABILITIES,canonical:CANONICAL,install,
