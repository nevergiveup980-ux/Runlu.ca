...
Key extraction: compact state structures and transition prompts.
...
Each stored decision should preserve facts available at the time, missing information, assumptions, alternatives, base rates where available, traditional inputs if used, evidence labels, scenarios, confidence, recommendation, falsification conditions, actual outcome and later model-weight adjustment.
