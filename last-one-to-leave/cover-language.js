(()=>{
  const BOOKS={
    ...
    evidence:{selector:'a.field-card[href="evidence/"]',covers:{en:'/evidence/cover-apple.jpg?v=20260906-3',zh:'/evidence/cover-apple.jpg?v=20260906-3',fr:'/evidence/cover-apple.jpg?v=20260906-3',es:'/evidence/cover-apple.jpg?v=20260906-3'},alts:{en:'All the Evidence Was There cover',zh:'《错序：所有证据都在》封面',fr:'Couverture de Toutes les preuves étaient là',es:'Portada de Todas las pruebas estaban allí'}}
  };
