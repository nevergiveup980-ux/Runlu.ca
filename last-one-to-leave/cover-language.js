(()=>{
  const BOOKS={
    ...
    evidence:{selector:'a.field-card[href="evidence/"]',covers:{en:'/evidence/cover-apple.svg?v=20260906-1',zh:'/evidence/cover-apple.svg?v=20260906-1',fr:'/evidence/cover-apple.svg?v=20260906-1',es:'/evidence/cover-apple.svg?v=20260906-1'},alts:{en:'All the Evidence Was There cover',zh:'《错序：所有证据都在》封面',fr:'Couverture de Toutes les preuves étaient là',es:'Portada de Todas las pruebas estaban allí'}}
  };
