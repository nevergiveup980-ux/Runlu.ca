...
const path=new URL('../flooring/week-schedule-v099.js',import.meta.url);
const source=fs.readFileSync(path,'utf8');
const ctx={globalThis:{},console};ctx.globalThis.globalThis=ctx.globalThis;
vm.createContext(ctx.globalThis);vm.runInContext(source,ctx.globalThis,{filename:'week-schedule-v099.js'});
const A=ctx.globalThis.RUNLUWeekScheduleV099;
